...
for i in range(len(uncertainty_level_list)):
    ...
    c = colors1[i]
    sns.lineplot(x="epoch", y=a, data=sdd_fed_fnn_trend, color=c, errorbar='sd', label=a)
# ax1.set_xlim((0, 51))
...
for i in range(len(uncertainty_level_list)):
    a = uncertainty_level_list[i]
    c = colors1[i]
    sns.lineplot(x="epoch", y=a, data=gsad_fed_fnn_trend, color=c, errorbar='sd', label=a)
# ax2.set_xlim((0, 250))
...
#     a = uncertainty_level_list[i]
#     c = colors1[i]
#     sns.lineplot(x="epoch", y=a, data=meterd_fed_fnn_trend, color=c, errorbar='sd', label=a)
# # ax3.set_xlim((0, 250))
...
#     a = uncertainty_level_list[i]
#     c = colors1[i]
#     sns.lineplot(x="epoch", y=a, data=wine_fed_fnn_trend, color=c, errorbar='sd', label=a)
# # ax4.set_xlim((0, 250))
...
for i in range(len(uncertainty_level_list)):
    a = uncertainty_level_list[i]
    c = colors1[i]
    sns.lineplot(x="epoch", y=a, data=magic_fed_fnn_trend, color=c, errorbar='sd', label=a)
# ax5.set_xlim((0, 250))
...
for i in range(len(uncertainty_level_list)):
    a = uncertainty_level_list[i]
    c = colors1[i]
    sns.lineplot(x="epoch", y=a, data=shuttle_fed_fnn_trend, color=c, errorbar='sd', label=a)
# ax6.set_xlim((0, 250))
...
for i in range(len(uncertainty_level_list)):
    a = uncertainty_level_list[i]
    c = colors1[i]
    sns.lineplot(x="epoch", y=a, data=robot_fed_fnn_trend, color=c, errorbar='sd', label=a)
# ax7.set_xlim((0, 250))
...
for i in range(len(uncertainty_level_list)):
    a = uncertainty_level_list[i]
    c = colors1[i]
    sns.lineplot(x="epoch", y=a, data=wifi_fed_fnn_trend, color=c, errorbar='sd', label=a)
# ax8.set_xlim((0, 250))

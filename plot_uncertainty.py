...
alg = ["DFNN (+)", 'DFNN (*)', "MOON (*)", "FEDAVG (*)", "FEDAVG (+)", "FedFNN (*)"]
...
for i in torch.arange(n_dataset):
    ...
    for j in torch.arange(len(uncertainty_level)):
        load_data_dir = f"{dataset_list[i]}_fed_fpnn_csm_r15c5p5_hetero0.5_nl{uncertainty_level[j]}_ce_lr0.001_e15cr1.mat"
...
sdd_trend = DataFrame(sdd_trend_data,
                      columns=["uncertainty_level", "DFNN (+)", "DFNN (*)", 'MOON (*)', "FEDAVG (*)", "FEDAVG (+)",
                               "FedFNN (*)"])
...
gsad_trend = DataFrame(gsad_trend_data, columns=["uncertainty_level", "DFNN (+)", "DFNN (*)", 'MOON (*)', "FEDAVG (*)", "FEDAVG (+)",
                               "FedFNN (*)"])
...
meterd_trend = DataFrame(meterd_trend_data, columns=["uncertainty_level", "DFNN (+)", "DFNN (*)", 'MOON (*)', "FEDAVG (*)", "FEDAVG (+)",
                               "FedFNN (*)"])
...
magic_trend = DataFrame(magic_trend_data, columns=["uncertainty_level", "DFNN (+)", "DFNN (*)", 'MOON (*)', "FEDAVG (*)", "FEDAVG (+)",
                               "FedFNN (*)"])
...
shuttle_trend = DataFrame(shuttle_trend_data, columns=["uncertainty_level", "DFNN (+)", "DFNN (*)", 'MOON (*)', "FEDAVG (*)", "FEDAVG (+)",
                               "FedFNN (*)"])
...
robot_trend = DataFrame(robot_trend_data, columns=["uncertainty_level", "DFNN (+)", "DFNN (*)", 'MOON (*)', "FEDAVG (*)", "FEDAVG (+)",
                               "FedFNN (*)"])
...
wifi_trend = DataFrame(wifi_trend_data, columns=["uncertainty_level", "DFNN (+)", "DFNN (*)", 'MOON (*)', "FEDAVG (*)", "FEDAVG (+)",
                               "FedFNN (*)"])
...
# ax1.legend(fontsize=15, loc='upper center', bbox_to_anchor=(2.35, 1.35), ncol=6, labels=alg)
tick_label = ['', '00%', '', "10%", '', '20%', '', '30%']

for i in range(len(alg)):
    a = alg[i]
    c = colors[i]
    sns.lineplot(x="uncertainty_level", y=a, data=sdd_trend, color=c, ci='sd', label=a)
# ax1.set_xlim((0, 51))
# ax1.set_ylim((0.77, 0.95))
ax1.set_ylabel('Test Accuracy',fontsize=18)
ax1.set_xlabel('Uncertainty level',fontsize=18)
plt.yticks(size=16)
plt.xticks(size=16)
...
for i in range(len(alg)):
    a = alg[i]
    c = colors[i]
    sns.lineplot(x="uncertainty_level", y=a, data=gsad_trend, color=c, ci='sd', label=a)
# ax2.set_xlim((0, 250))
# ax2.set_ylim((0.77, 0.95))
ax2.set_ylabel('Test Accuracy',fontsize=18)
ax2.set_xlabel('Uncertainty level',fontsize=18)
plt.yticks(size=16)
plt.xticks(size=16)
...
for i in range(len(alg)):
    a = alg[i]
    c = colors[i]
    sns.lineplot(x="uncertainty_level", y=a, data=meterd_trend, color=c, ci='sd', label=a)
# ax3.set_xlim((0, 250))
# ax3.set_ylim((0.77, 0.95))
ax3.set_ylabel('Test Accuracy',fontsize=18)
ax3.set_xlabel('Uncertainty level',fontsize=18)
plt.yticks(size=16)
plt.xticks(size=16)
...
ax3.set_title('FM', size=19)

ax6 = plt.subplot(234)
for i in range(len(alg)):
    a = alg[i]
    c = colors[i]
    sns.lineplot(x="uncertainty_level", y=a, data=shuttle_trend, color=c, ci='sd', label=a)
# ax6.set_xlim((0, 250))
# ax6.set_ylim((0.77, 0.95))
ax6.set_ylabel('Test Accuracy',fontsize=18)
ax6.set_xlabel('Uncertainty level',fontsize=18)
plt.yticks(size=16)
plt.xticks(size=16)
...
for i in range(len(alg)):
    a = alg[i]
    c = colors[i]
    sns.lineplot(x="uncertainty_level", y=a, data=robot_trend, color=c, ci='sd', label=a)
# ax7.set_xlim((0, 250))
# ax7.set_ylim((0.77, 0.95))
ax7.set_ylabel('Test Accuracy',fontsize=18)
ax7.set_xlabel('Uncertainty level',fontsize=18)
plt.yticks(size=16)
plt.xticks(size=16)
...
for i in range(len(alg)):
    a = alg[i]
    c = colors[i]
    sns.lineplot(x="uncertainty_level", y=a, data=wifi_trend, color=c, ci='sd', label=a)
# ax8.set_xlim((0, 250))
# ax8.set_ylim((0.77, 0.95))
ax8.set_ylabel('Test Accuracy',fontsize=18)
ax8.set_xlabel('Uncertainty level',fontsize=18)
plt.yticks(size=16)
plt.xticks(size=16)
...
ax1.legend(fontsize=20, loc='upper center', bbox_to_anchor=(1.73, 1.40), ncol=6)
plt.savefig(f"./results/uncertainty_trend.pdf",bbox_inches='tight')
print("lslsl")